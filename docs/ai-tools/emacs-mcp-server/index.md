...
See the [Tutorial](./tutorial) for detailed installation instructions covering Ubuntu 24.04, vanilla Emacs, and Doom Emacs.
...
### Java (Quarkus) — recommended for MCP Gateway integration
