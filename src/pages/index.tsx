...
const articles = [
  ...
  {
    title: 'The POJO-actor Journey: v1.0.0 to v2.12.0',
    url: '/blog/pojo-actor-journey-v1.0-to-v2.12',
    date: 'Jan 26, 2026',
    description: 'A retrospective on the evolution of POJO-actor from initial release through v2.12.0.',
    pattern: 'waves',
    isInternal: true,
  },
  {
